...
const tool: OpenAI.Chat.Completions.ChatCompletionTool = {
	...
	function: {
		name: "update_task",
		description: "Updates the task with the given information",
		parameters: {
			type: "object",
			properties: {
				id: {
								...
								deadlineInfo: {
									...
									properties: {
										...
										lastNotificationDate: {
											type: "string",
											description: `The date when the user was last notified about the task (format: ${LDATE_FORMAT})`,
										},
									},
									required: [
										"deadlineDate",
			...
			required: ["id", "information", "label", "priority", "schedule"],
			additionalProperties: false,
		},
		strict: true,
	},
